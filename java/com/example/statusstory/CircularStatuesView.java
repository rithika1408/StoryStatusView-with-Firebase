...
public class CircularStatuesView extends View {
    ...
    public CircularStatuesView(Context context) {
        super(context);
        init(context, null, -1);
    }

    private void init(Context context, AttributeSet attrs, int defStyle) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircularStatuesView, defStyle, 0);

        if (a != null) {
            portionColor = a.getColor(R.styleable.CircularStatuesView_portion_color, DEFAULT_COLOR);
            portionWidth = a.getDimensionPixelSize(R.styleable.CircularStatuesView_portion_width, (int) DEFAULT_PORTION_WIDTH);
            portionSpacing = a.getDimensionPixelSize(R.styleable.CircularStatuesView_portion_spacing, DEFAULT_PORTION_SPACING);
            portionsCount = a.getInteger(R.styleable.CircularStatuesView_portions_count, (int) DEFAULT_PORTIONS_COUNT);
    ...
    public CircularStatuesView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, -1);
    }

    public CircularStatuesView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
